...
describe("add", () => {
  describe("position mode", () => {
    ...
    test("it should not mutate original opcode", () => {
      const opcode = [1, 9, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50];
      add(opcode, 0);
      expect(opcode).toEqual([1, 9, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50]);
    });
  });
...
describe("multiply", () => {
  describe("position mode", () => {
    test("correctly multiplies (70 in pos 3 * 50 in pos 11 = 3500 in pos 0)", () => {
      const opcode = [1, 9, 10, 70, 2, 3, 11, 0, 99, 30, 40, 50];
...
describe("jumpIfTrue", () => {
  describe("position mode", () => {
    test("should return pointer + 3 if value at first parameter is zero", () => {
      const opcode = [5, 3, 2, 0];
      expect(jumpIfTrue(opcode, 0)).toEqual(3);
    });
  ...
  describe("immediate mode", () => {
    test("should return pointer + 3 if first parameter is zero", () => {
...
describe("jumpIfFalse", () => {
  describe("position mode", () => {
    test("should return pointer + 3 if value at first parameter is not zero", () => {
      const opcode = [6, 3, 2, 1];
      expect(jumpIfFalse(opcode, 0)).toEqual(3);
    });
  ...
  describe("immediate mode", () => {
    test("should return pointer + 3 if first parameter is not zero", () => {
